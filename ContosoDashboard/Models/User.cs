...
public class User
{
    ...
    public virtual ICollection<DocumentShare> DocumentSharesGranted { get; set; } = new List<DocumentShare>();
    public virtual ICollection<DocumentShare> DocumentSharesReceived { get; set; } = new List<DocumentShare>();
    public virtual ICollection<DocumentAuditEvent> DocumentAuditEvents { get; set; } = new List<DocumentAuditEvent>();
}
