...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DocumentShare>()
            ...
            .WithMany(u => u.DocumentSharesGranted)
        ...
        modelBuilder.Entity<DocumentAuditEvent>()
            ...
            .WithMany(u => u.DocumentAuditEvents)
        ...
        modelBuilder.Entity<Document>()
            .HasIndex(d => new { d.UploadedByUserId, d.UploadedDate });
        modelBuilder.Entity<Document>()
            .HasIndex(d => new { d.ProjectId, d.IsDeleted });
        modelBuilder.Entity<Document>()
            .HasIndex(d => new { d.Category, d.UploadedDate });
        modelBuilder.Entity<Document>()
            .HasIndex(d => d.StorageKey)
            .IsUnique();
        modelBuilder.Entity<DocumentShare>()
            .HasIndex(s => new { s.DocumentId, s.RecipientUserId, s.ProjectId, s.RevokedDate });
        modelBuilder.Entity<DocumentAuditEvent>()
